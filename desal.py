...
#iski side pa 2-3 keys thi to check karna paraga ki yea sahi ha ki nahi
#extra elements ar edited in data because data length should be divisible by 8. it is done using padding
